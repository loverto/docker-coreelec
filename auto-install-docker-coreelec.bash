...
DOCKER_URL="https://github.com/loverto/docker-coreelec/releases/download/${DOCKER_TAG}/${DOCKER_FILE}"
...
echo "For more information about the package visit https://github.com/loverto/docker-coreelec"
echo ""
